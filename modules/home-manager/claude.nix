...
in
{
  home = {
    ...
    file = {
      ...
      ".claude/plugins/cache/superpowers-marketplace/superpowers/5.0.7".source = superpowers-src;
      ".claude/plugins/cache/claude-plugins-official/superpowers/5.0.7".source = superpowers-src;
      ".claude/plugins/cache/claude-hud/claude-hud/0.0.11".source = claude-hud-src;

      # --- Marketplace repos ---
      ".claude/plugins/marketplaces/superpowers-marketplace".source = superpowers-marketplace-src;
      ".claude/plugins/marketplaces/claude-plugins-official".source = claude-plugins-official-src;
      ".claude/plugins/marketplaces/claude-hud".source = claude-hud-src;

      # --- known_marketplaces.json ---
      ".claude/plugins/known_marketplaces.json".text = builtins.toJSON {
