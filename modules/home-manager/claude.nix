...
in
{
  ...
  home.file.".claude/plugins/cache/superpowers-marketplace/superpowers/5.0.7".source = superpowers-src;
  home.file.".claude/plugins/cache/claude-plugins-official/superpowers/5.0.7".source = superpowers-src;
  home.file.".claude/plugins/cache/claude-hud/claude-hud/0.0.11".source             = claude-hud-src;

  # --- Marketplace repos ---
  home.file.".claude/plugins/marketplaces/superpowers-marketplace".source = superpowers-marketplace-src;
  home.file.".claude/plugins/marketplaces/claude-plugins-official".source = claude-plugins-official-src;
